...
$job = Start-Job -ScriptBlock $jobScript -Name "SessionTerminator"

Write-Log "Started background job 'SessionTerminator' with ID $($job.Id)"
Write-Host "Background job started. Check logs at $logFile"